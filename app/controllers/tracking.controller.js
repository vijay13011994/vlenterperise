...
const createTracking = async (req, res) => {
    try{
        ...
        if(!["::ffff:13.229.195.68", "::ffff:18.139.238.62", "::ffff:52.76.70.1", "::ffff:13.127.20.101", "::ffff:13.126.12.240", "::ffff:35.154.161.83", "::ffff:206.84.229.78", "::ffff:3.6.106.39", "::ffff:18.61.175.16"].includes(req.ip)){
